...
const resourceKPIs = [
  {
    ...
    requiredPermission: "canViewResources" as const
  },
  {
    title: "Billable",
    value: "189",
...
export const ResourceManagementView = () => {
  ...
  const { hasPermission, permissions, userRole } = useRBAC();
  ...
  const visibleKPIs = resourceKPIs.filter(kpi => hasPermission(kpi.requiredPermission));

  return (
    <PermissionGate requiredPermission="canViewResources">
      <div className="min-h-screen bg-light-bg">
        <div className="container mx-auto px-6 py-6">
            ...
            <CardHeader className="border-b bg-light-bg rounded-t-2xl border-deep-blue/20 p-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <Badge className="mt-2 bg-deep-blue/10 text-deep-blue border-deep-blue/20">
                    {userRole?.toUpperCase()} Access Level
                  </Badge>
                </div>
              </div>
            </CardHeader>
          ...
          {/* Enhanced KPI Cards with Role-Based Access */}
          ...
          {/* Navigation Tabs with Role-Based Content */}
          <Card className="bg-white rounded-2xl shadow-lg border border-deep-blue/20 mb-8">
              ...
              <Tabs defaultValue="actions" className="w-full">
                ...
                <TabsContent value="actions" className="mt-6">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <PermissionGate requiredPermission="canAddResources">
                    ...
                    <PermissionGate requiredPermission="canAddProjects">
                    ...
                    <PermissionGate requiredPermission="canAllocateResources">
                ...
                <TabsContent value="overview" className="mt-6">
                  <PermissionGate requiredPermission="canViewAnalytics">
