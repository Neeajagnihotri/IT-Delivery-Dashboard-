            ...
            <Card className="bg-white border-slate/30">
              ...
              <CardContent className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-deep-blue">{resource.email || `${resource.name.toLowerCase().replace(' ', '.')}@zapcom.com`}</span>
                </div>
                <div className="flex items-center gap-3">
                  <Phone className="h-4 w-4 text-slate" />
                  <span className="text-deep-blue">{resource.phone || '+1 (555) 123-4567'}</span>
                </div>
                <div className="flex items-center gap-3">
          ...
          <Card className="bg-white border-slate/30">
            ...
            <CardContent>
              <div className="flex flex-wrap gap-2">
                {(resource.skills || ['React', 'TypeScript', 'Node.js', 'AWS']).map((skill, index) => (
